...
public class DefaultBuildCacheController implements BuildCacheController {
    ...
    @Override
    public <T> Optional<Try<T>> load(final BuildCacheLoadCommand<T> command) {
        ...
        if (local.canLoad()) {
            ...
            if (unpack.result != null) {
                return Optional.of(unpack.result.getUnpackResult());
            }
        }
        ...
        if (result == null) {
            ...
            return Optional.of(result.getUnpackResult());
        }
    }
